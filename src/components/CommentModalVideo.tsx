...
interface CommentModalVideoProps {
    videoId: string;
    comments: Comment[];
...
export default function CommentModalVideo({
    ...
    const formatTime = (dateString: string) => {
        ...
        const diff = Math.floor((now.getTime() - commentDate.getTime()) / 60000);
        ...
        return (
            <View style={styles.replyItem} key={reply.id}>
                ...
                <View style={styles.actionsColumn}>
                    <TouchableOpacity onPress={() => onLikeComment(reply.id)} style={styles.likeButton}>
                        <Ionicons
                    ...
                    {canDelete && (
                        <TouchableOpacity onPress={() => handleDelete(reply.id, parentId)} style={styles.deleteButton}>
            ...
            <View style={styles.commentWrapper} key={item.id}>
                <View style={styles.commentItem}>
                    ...
                    <View style={styles.actionsColumn}>
                        ...
                        {canDelete && (
                            <TouchableOpacity onPress={() => handleDelete(item.id, null)} style={styles.deleteButton}>
