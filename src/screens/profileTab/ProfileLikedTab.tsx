...
const ProfileLikedTab: React.FC = () => {
    ...
    return (
        <ScrollView>
            {/* Menu con riêng cho tab "Đã thích" */}
            <View style={styles.subMenu}>
                <TouchableOpacity
                    style={[styles.subBtn, menu === 'video' && styles.active]}
                    onPress={() => setMenu('video')}
                >
                    <Text style={[styles.subText, menu === 'video' && styles.activeText]}>
                        Video
                    </Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={[styles.subText, menu === 'image' && styles.activeText]}>
                        Hình ảnh
                    </Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    subBtn: { paddingVertical: 5, paddingHorizontal: 10 },
    subText: { color: '#666', fontSize: 14 },
    active: { borderBottomWidth: 2, borderBottomColor: '#FF4EB8' },
